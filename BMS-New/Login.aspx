<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BMS_New.Login" %>
...
<head>
    <base href="../../../">
    <meta charset="utf-8" />
    <title>BMS || Board Meeting Software</title>
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                        <form class="form" novalidate="novalidate" id="kt_login_signin_form1" runat="server">
                            <asp:TextBox ID="txtSalt" Text="" runat="server" Style="visibility: hidden;" />
                            <asp:TextBox ID="txtMSalt" Text="" runat="server" Style="visibility: hidden;" />
                            <!--begin::Title-->
                            ...
                            <div class="form-group">
                               ...
                               <%-- <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="text" name="username" autocomplete="off" />--%>
                                <asp:TextBox ID="txtLoginId" runat="server" CssClass="form-control form-control-lg form-control-solid" autocomplete="off" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Form group-->
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPwd" TextMode="Password" runat="server" CssClass="form-control form-control-lg form-control-solid" autocomplete="off" />
                            </div>
                            <!--end::Form group-->
                            <!--begin::Action-->
                            <div class="pb-lg-0 pb-5">
                                ...
                                <asp:Button ID="Button1" runat="server" OnClientClick="return fnLogin();" CssClass="btn btn-lg btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" OnClick="Button1_Click" Text="Login" />
    ...
    <!--end::Main-->
                 <!--begin::Modal-->
    <div class="modal fade" id="stack1" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg" data-backdrop="static" data-keyboard="false" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" style="width: 771px;" >
            <div class="modal-content">
                <div class="modal-header">
                   <button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true"><i aria-hidden="true" class="ki ki-close"></i></button>
