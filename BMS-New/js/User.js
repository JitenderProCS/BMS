        ...
        success: function (msg) {
            ...
            if (msg.StatusFl) {
                ...
                for (var i = 0; i < msg.UserList.length; i++) {
                    ...
                    result += '<td id="tdUser_Role_' + msg.UserList[i].ID + '">' + msg.UserList[i].role + '</td>';
...
function User(ID, userFirstName, userMiddleName, userLastName, emailId, role, salutation, phone, address, tenureStartDate, tenureEndDate, dateOfBirth,
    nationality, userLogin, password, status, DepartmentName, DesignationName, CategoryName, profile, txtdp_pan, panremark, txtdin_pan, din_remark,
