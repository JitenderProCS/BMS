<%@ Page Title="" Language="C#" MasterPageFile="~/BMSMaster.Master" AutoEventWireup="true" CodeBehind="UserMasterForAdmin1.aspx.cs" Inherits="DMS.UserMasterForAdmin1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
                                                    ...
                                                    <table class="table" id="authtable">
                                                      ...
                                                      <tbody> 
                                                        <tr> 
                                                          ...
                                                          <td>
                                                              <select id="ddlmodule" class="form-control form-control-lg form-control-solid col">
                                                                    <option selected="selected" value="0">Select Module</option>
                                                        ...
                                                        <td><button class="btn btn-primary " onclick="addNewRow()" type="button">Add</button></td>
                                                        </tr>
                                                      </tbody>
                                                    </table>
    ...
    <script>
        ...
        function addNewRow() {
            gettableid.innerHTML += `<tr><td><select id="ddlCompany" class="form-control form-control-lg form-control-solid col"> +
                                                                        <option selected="selected" value="0">Select Company</option> +
                                                                         <option value="TATA">TATA </option>
                                                                          <option value="TCS">TCS </option>
...
<asp:Content ID="Content6" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script src="js/AdminUser.js?<%=DateTime.Now%>"></script>
</asp:Content>
