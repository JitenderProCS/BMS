                            ...
                            if (dt.Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow dr in dt.Rows)
                                {
                                   ...
                                   // obj.role = (!String.IsNullOrEmpty(Convert.ToString(dr["USER_ROLE1"]))) ? Convert.ToString(dr["USER_ROLE1"]) : String.Empty;
                                    ...
                                    obj.tenureStartDate = (!String.IsNullOrEmpty(Convert.ToString(dr["TENURE_START"]))) ? (Convert.ToString(dr["TENURE_START"]) == "1900-01-01 00:00:00.000" ? "" : Convert.ToString(Convert.ToDateTime(dr["TENURE_START"]).ToString("dd/MM/yyyy"))) : String.Empty;
                                    obj.tenureEndDate = (!String.IsNullOrEmpty(Convert.ToString(dr["TENURE_END"]))) ? (Convert.ToString(dr["TENURE_END"]) == "1900-01-01 00:00:00.000" ? "" : Convert.ToString(Convert.ToDateTime(dr["TENURE_END"]).ToString("dd/MM/yyyy"))) : String.Empty;
                                    obj.dateOfBirth = (!String.IsNullOrEmpty(Convert.ToString(dr["DATE_OF_BIRTH"]))) ? (Convert.ToString(dr["DATE_OF_BIRTH"]) == "1900-01-01 00:00:00.000" ? "" : Convert.ToString(Convert.ToDateTime(dr["DATE_OF_BIRTH"]).ToString("dd/MM/yyyy"))) : String.Empty;
                                    // obj.tenureStartDate = (!String.IsNullOrEmpty(Convert.ToString(dr["TENURE_START"]))) ? Convert.ToString(dr["TENURE_START"]) : String.Empty;
                                    // obj.tenureEndDate = (!String.IsNullOrEmpty(Convert.ToString(dr["TENURE_END"]))) ? Convert.ToString(dr["TENURE_END"]) : String.Empty;
                                    // obj.dateOfBirth = (!String.IsNullOrEmpty(Convert.ToString(dr["DATE_OF_BIRTH"]))) ? Convert.ToString(dr["DATE_OF_BIRTH"]) : String.Empty;
