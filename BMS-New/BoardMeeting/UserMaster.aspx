<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BoardMeeting/BMSMaster.Master" CodeBehind="UserMaster.aspx.cs" Inherits="BMS_New.BoardMeeting.UserMaster" %>
                                                ...
                                                <div class="col-xl-12">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input id="txtEmail" type="email" class="form-control form-control-solid form-control-lg"  placeholder="Email Address" onkeypress="javascript:fnRemoveClass(this,'Email');" autocomplete="on" maxlength="100" /> <%--onchange="javascript:fnFillUserDetails();"--%>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end::Group-->
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-xl-9 col-lg-9">
                                                                <select id="ddlRole" class="form-control form-control-lg form-control-solid" name="language" onchange="getdiv(this); fnRemoveClass(this,'Role');">
                                                             <option value="0">Please Select</option>
                                                          </select>
