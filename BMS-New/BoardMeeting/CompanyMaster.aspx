<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BoardMeeting/BMSMaster.Master" CodeBehind="CompanyMaster.aspx.cs" Inherits="BMS_New.BoardMeeting.CompanyMaster" %>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!--end::Group-->
                    <!--dropdown start-->
                    <div id="divCompanyType" class="form-group row">
