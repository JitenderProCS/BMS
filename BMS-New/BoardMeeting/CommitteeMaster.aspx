<%@ Page Title="" Language="C#" MasterPageFile="~/BoardMeeting/BMSMaster.Master" AutoEventWireup="true" CodeBehind="CommitteeMaster.aspx.cs" Inherits="BMS_New.BoardMeeting.CommitteeMaster" %>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <!--begin::Group-->
                     <div class="form-group row">
                        <label id="lblChairman" style="text-align: right;padding-left: 0px;" class="col-xl-3 col-lg-3 col-form-label">Chairman/Chairperson </label>
                        <div class="col-lg-9 col-xl-9">
                 ...
                 <!--end::Group-->
                      <!--begin::Group-->
                    <div class="form-group row" >
                        <label id="lblCoordinator" style="text-align: left" class="col-xl-3 col-lg-3 col-form-label">Committee Member(s)</label>
                    ...
                    <div id="Coordinator" class="form-group row">
                     ...
                     <!--end::Group-->
                       <!--begin::Group-->
                    <div class="form-group row" >
                        <label id="lblSelectCoordinator" style="text-align: left" class="col-xl-3 col-lg-3 col-form-label">Committee Coordinator(s)</label>
                        <div class="form-group row" style="margin-left:11.5px">
                              <select id="ddlSelectCoordinator" style="width: 406px;" class="form-control form-control-lg form-control-solid col" onchange="javascript:fnRemoveClass(this,'SelectCoordinator');">
                               </select>&nbsp;
                             <select id="ddlSelectRole" style="width: 10px;" class="form-control form-control-lg form-control-solid col" onchange="javascript:fnRemoveClass(this,'SelectRole');">
                               </select>&nbsp; &nbsp;
