<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/BoardMeeting/BMSMaster.Master" CodeBehind="Dashboard.aspx.cs" Inherits="BMS_New.BoardMeeting.Dashboard" %>
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <%--<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">
						Dashboard<span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
					</h1>--%>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
